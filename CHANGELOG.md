...
### Added
- Configurable scanning options via `config.json` and Generic Mod Config Menu
- Settings to enable/disable scanning for crops, machines, and hay
- Configurable minimum quality threshold for cask alerts (normal/silver/gold/iridium)
